...
/*
  This example sketch is used to make sure the Arduino works correctly and can receive
  data through the serial port. Edit the pin numbers and messages according to your
  needs.
*/
...
//SoftwareSerial Serial(8, 7); // Serial

byte buffer[10];
char incomebyte;
int scrollSpeed = 100;
char text[100] = " message of your choice here "; // Initial text message
int brightness = 15;
int count = 0;
char indicator;
